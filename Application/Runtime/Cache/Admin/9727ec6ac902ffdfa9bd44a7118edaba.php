            ...
            <ul id="navi-root">
                ...
                <li id="navi-articles" class="navi-active" onclick="show('navi-articles')">
                    ...
                    <ul class="navi-sub" style="display: block" id="navi-sub-articles">
                        <li><a href="/brtobj/index.php/Admin/article/allarticle" class="navi-a-active" onclick="subshow('navi-sub-articles',0)">所有文章</a>
                        </li>
                        <li><a href="/brtobj/index.php/Admin/article/newarticle" onclick="subshow('navi-sub-articles',1)">新文章</a></li>
                    </ul>
                </li>
            ...
            <div style="padding: 20px 20px; text-align: left">
                <table id="one-glance">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                            ...
                            <td style="color: #777777"><?php echo ($vo["title"]); ?></td>
                            <td style="color: #777777"><?php echo (date( "Y-m-d H:i:s",$vo["ctime"])); ?></td>
                            ...
                            <td>
                                ...
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                <a href="/brtobj/index.php/Admin/Article/xianshi/id/<?php echo ($vo["id"]); ?>" onclick="return shifou();">显示</a>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                <a href="/brtobj/index.php/Admin/Article/delete/id/<?php echo ($vo["id"]); ?>" onclick="return shifou();">回收</a>
                            </td>
