                ...
                <li id="navi-category" onclick="show('navi-category')">
                    ...
                    <ul class="navi-sub" id="navi-sub-category">
                        <li><a href="/brtobj/index.php/Admin/category/allcategory"
                               onclick="subshow('navi-category',0)">所有分类</a></li>
                        <li><a href="#" onclick="subshow('navi-category',1)">新分类</a></li>
                    </ul>
                </li>
                <li id="navi-tag" class="navi-active" onclick="show('navi-tag')">
                    <a href="/brtobj/index.php/Admin/tag/alltag">
                        <span class="front"></span>
                        <span>标签管理</span>
                        <span class="end"></span>
                    </a>
                    <ul class="navi-sub" style="display: block" id="navi-sub-tag">
                        <li><a href="/brtobj/index.php/Admin/tag/alltag" class="navi-a-active" onclick="subshow('navi-sub-tag',0)">所有标签</a></li>
    ...
    <div id="container-right">
        <div id="content">
            <div class="content-title">
                <a href="/brtobj/index.php/Admin/tag/alltag">所有标签</a>
            </div>
            <div style="padding: 20px 20px; text-align: left">
                <table id="one-glance">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                            <td style="color: #777777"><?php echo ($vo["id"]); ?></td>
                            <td style="color: #777777"><?php echo ($vo["name"]); ?></td>
                            <td style="color: #777777"><?php echo ($vo["article"]); ?></td>
                            <td style="color: #777777"><?php echo ($vo["aid"]); ?></td>
                            <td>
                                <a href="/brtobj/index.php/Home/Article/index/id/<?php echo ($vo["name"]); ?>" target="_blank">修改</a>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                <a href="/brtobj/index.php/Admin/Tag/delete/id/<?php echo ($vo["name"]); ?>" onclick="return shifou();">回收</a>
                            </td>
