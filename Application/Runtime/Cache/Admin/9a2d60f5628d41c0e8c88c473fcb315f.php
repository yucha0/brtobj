            ...
            <ul id="navi-root">
                ...
                <li id="navi-category" class="navi-active" onclick="show('navi-category')">
                    ...
                    <ul class="navi-sub" style="display: block" id="navi-sub-category">
                        <li><a href="/brtobj/index.php/Admin/category/allcategory" class="navi-a-active"
                               onclick="subshow('bavi-sub-category',0)">所有分类</a></li>
                        <li><a href="/brtobj/index.php/Admin/category/newcategory" onclick="subshow('navi-sub-category',1)">新分类</a></li>
                    </ul>
                </li>
            ...
            <div style="padding: 20px 20px; text-align: left">
                <table id="one-glance">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                            ...
                            <td>
                                <a href="/brtobj/index.php/Admin/category/newcategory/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                <a href="/brtobj/index.php/Admin/category/delete/id/<?php echo ($vo["id"]); ?>">回收</a>
                            </td>
