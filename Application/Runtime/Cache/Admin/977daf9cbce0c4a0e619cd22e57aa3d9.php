...
<div id="container">
    <div id="container-left">
        <div id="navi">
            ...
            <ul id="navi-root">
                ...
                <li id="navi-comments" class="navi-active" onclick="show('navi-comments')">
                    <a href="/brtobj/index.php/Admin/comment/allcomment">
                        <span class="front"></span>
                        <span>评论管理</span>
                        <span class="end"></span>
                    </a>
                    <ul class="navi-sub" style="display: block" id="navi-sub-comments">
                        <li><a class="navi-a-active"  href="/brtobj/index.php/Admin/comment/allcomment">所有评论</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div id="container-right">
        <div id="content">
            ...
            <div style="padding: 20px 20px; text-align: left; border-radius: 4px">
                <table id="one-glance">
                    <tbody>
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                            <td rowspan="5" style="width: 5%"><?php echo ($vo["id"]); ?></td>
                            <td style="width: 15%">昵称</td>
                            <td style="width: 20%;color: #777777;"><?php echo ($vo["nickname"]); ?></td>
                            <td style="width: 10%">邮箱</td>
                            <td style="width: 20%;color: #777777;"><?php echo ($vo["mail"]); ?></td>
                            <td style="width: 10%">ip</td>
                            <td style="width: 20%;color: #777777;"><?php echo ($vo["ip"]); ?></td>
                        </tr>
                        <tr>
                            <td>状态</td>
                            <td>
                                <?php if($vo["status"] == 1): ?><span style="color: #777777;">显示</span>
                                <?php else: ?>
                                <span style="color:red;">回收</span><?php endif; ?>
                            </td>
                            <td>文章ID</td>
                            <td style="color: #777777;"><?php echo ($vo["aid"]); ?></td>
                            <td>父ID</td>
                            <td style="color: #777777;"><?php echo ($vo["pid"]); ?></td>
                        </tr>
                        <tr>
                            <td colspan="1">文章标题</td>
                            <td colspan="5" style="color: #777777;"><?php echo ($vo["article"]); ?></td>
                        </tr>
                        <tr>
                            <td colspan="1">评论内容</td>
                            <td colspan="5" style="color: #777777;"><?php echo ($vo["content"]); ?></td>
                        </tr>
                        <tr style="border-bottom: 2px solid rgba(45, 112, 145, .2);">
                            <td colspan="6" style="text-align: center">
                                ...
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                <a href="/brtobj/index.php/Admin/Comment/xianshi/id/<?php echo ($vo["id"]); ?>" onclick="return shifou();">显示</a>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                <a href="/brtobj/index.php/Admin/Comment/delete/id/<?php echo ($vo["id"]); ?>" onclick="return shifou();">回收</a>
                            </td>
