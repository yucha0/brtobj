...
!function(a) {
    if ("function" == typeof define && define.amd && define("uikit", function() {
            ...
            return f.load = function(a, b, g, e) {
                ...
                if (!k)
                    throw Error("Please define base path to UIkit in the requirejs config.");
    ...
    if (b.version = "2.25.0", b.noConflict = function() {
            ...
            for (var a = ["webkit", "moz"], b = 0; b < a.length &&
            ...
            a && setTimeout(function() {
                try {
                    for (v =
                        ...
                        b = c = 0;
                        for (q = h.cssRules.length; q > c; b=++c)
                            h.cssRules[b].type === CSSRule.STYLE_RULE && a.test(h.cssRules[b].selectorText) && d.unshift(b);
                        g = 0;
                        for (u = d.length; u > g; g++)
                            h.deleteRule(d[g])
                    }
                } catch (w) {}
            }, 0)
            ...
            for (var d, h, e, c, g = a.replace(/\n/g, "\\n").replace(/\{\{\{\s*(.+?)\s*\}\}\}/g, "{{!$1}}").split(/(\{\{\s*(.+?)\s*\}\})/g), f = 0, q = [], u = 0; f < g.length;) {
                if (d = g[f], d.match(/\{\{\s*(.+?)\s*\}\}/))
                    switch (f += 1, d = g[f], h = d[0], e = d.substring(d.match(/^(\^|\#|\!|\~|\:)/) ? 1 : 0), h) {
                        case "~":
            ...
            b.support.mutationobserver && (d = d || function() {}, b.$(a).each(function() {
                var a = this, k = b.$(a);
                if (!k.data("observer"))
                    try {
    ...
    if (!a.fn.swipeLeft) {
        ...
        a(function() {
            ...
            a(document).on("MSGestureEnd gestureend",
                ...
                if ("MSPointerMove" != a.type || g(a.originalEvent))
                    n = "MSPointerMove" == a.type || "pointermove" == a.type ? a : a.originalEvent.touches[0], l && clearTimeout(l), l = null, h.x2 = n.pageX, h.y2 = n.pageY, t += Math.abs(h.x1 - h.x2), q += Math.abs(h.y1 - h.y2)
            }).on("touchend MSPointerUp pointerup",
                function(c) {
                    if ("MSPointerUp" != c.type || g(c.originalEvent))
                        l && clearTimeout(l), l = null, h.x2 && 30 < Math.abs(h.x1 - h.x2) || h.y2 && 30 < Math.abs(h.y1 - h.y2) ? k = setTimeout(function() {
...
(function(a) {
    ...
    a.component("stackMargin", {
        ...
        process: function() {
            ...
            if (a.Utils.stackMargin(b, this.options), !this.options.rowfirst)
                return this;
...
(function(a) {
    var f = a.$win, c = a.$doc, b = [], g = function() {
        for (var a = 0; a < b.length; a++)
            window.requestAnimationFrame.apply(window, [b[a].check])
    };
    ...
    var e = [], d = function() {
        for (var a = 0; a < e.length; a++)
            window.requestAnimationFrame.apply(window, [e[a].check])
    };
        ...
        init: function() {
            var b, d = [], c = this.find("a[href^='#']").each(function() {
                ...
                for (var d = 0; d < h.length; d++)
                    a.Utils.isInView(h.eq(d), n.options) && b.push(h.eq(d));
                if (b.length) {
                    var e, d = f.scrollTop();
                    a:
                    {
        ...
        toggle: function() {
            if (this.totoggle.length) {
                if (this.options.animation && a.support.animation) {
                    ...
                    this.totoggle.toggleClass(this.options.cls), a.Utils.checkDisplay(this.totoggle);
                this.updateAria()
            }
        },
        getToggles: function() {
    ...
    a.component("dropdown", {
        ...
        checkDimensions: function() {
            if (this.dropdown.length) {
                ...
                if (b = n.split("-"), q = t[n] ? t[n] : t["bottom-left"], this.justified && this.justified.length)
                    f(p.css({
                            left: 0
                        }),
                        this.justified, r);
...
(function(a) {
    ...
    a.component("gridMatchHeight", {
        ...
        match: function() {
            ...
            if (c.length)
                return 100 <= Math.ceil(100 * parseFloat(c.css("width")) / parseFloat(c.parent().css("width"))) &&
                !this.options.ignorestacked ? this.revert() : a.Utils.matchHeights(this.elements, this.options), this
        },
        revert: function() {
    ...
    a.component("modal", {
        ...
        show: function() {
            if (this.element.length) {
                var d = this;
                if (!this.isActive())
                    return this.options.modal && b && b.hide(!0), this.element.removeClass("uk-open").show(), this.resize(), this.options.modal && (b = this), this.active=!0, g++, a.support.transition ? (this.hasTransitioned=!1, this.element.one(a.support.transition.end, function() {
                        d.hasTransitioned=!0
    ...
    a.component("nav", {
        ...
        open: function(c, b) {
            ...
            k && (d.hasClass("uk-open") && k.removeClass("uk-hidden"), b ? (k.stop().height(d.hasClass("uk-open") ?
                "auto" : 0), d.hasClass("uk-open") || k.addClass("uk-hidden"), this.trigger("display.uk.check")) : k.stop().animate({
    ...
    var f = window.scrollX, c = window.scrollY, b = (a.$win, a.$doc, a.$html), g = {
        ...
        _initElement: function(b) {
            b.data("OffcanvasInit") || (b.on("click.uk.offcanvas swipeRight.uk.offcanvas swipeLeft.uk.offcanvas", function(b) {
                var e = a.$(b.target);
                if (b.type.match(/swipe/) || e.hasClass("uk-offcanvas-close") ||!e.hasClass("uk-offcanvas-bar") &&
                    !e.parents(".uk-offcanvas-bar:first").length)
...
!function(a) {
    ...
    function f(b, d, c) {
        ...
        }, x.onerror = function() {}, x.onload = function() {
            f = {
                w: x.width,
                h: x.height
            };
    ...
    a.component("parallax", {
        ...
        boot: function() {
            g = function() {
                ...
                for (var c in d)
                    void 0 !== b.style[c] && (b.style[c] = "translate3d(1px,1px,1px)",
...
!function(a) {
    ...
    function f() {
        ...
        if (d.length&&!(0 > c.scrollTop()))
            for (var e, f, p, h, m = c.scrollTop(), r = b.height(), n = c.height(), n = r - n, n = m > n ? n - m : 0, t = 0; t < d.length; t++)
                if (h = d[t], h.element.is(":visible")&&!h.animate) {
                    if (h.check()) {
                        if (0 > h.top ? e = 0 : (p = h.element.outerHeight(), e = r - p - h.top - h.options.bottom - m - n, e = 0 > e ? e + h.top : h.top), h.boundary &&
                            h.boundary.length)
                            f = h.boundary.offset().top, f = h.boundtoparent ? r - (f + h.boundary.outerHeight()) + parseInt(h.boundary.css("padding-bottom")) : r - f - parseInt(h.boundary.css("margin-top")), e = m + p > r - f - (0 > h.top ? 0 : h.top) ? r - f - (m + p) : e;
                        if (h.currentTop != e) {
                            if (h.element.css({
                                    position: "fixed",
                                    top: e,
                                    width: h.getWidthFrom.length ? h.getWidthFrom.width(): h.element.width()
                                }), !h.init && (h.element.addClass(h.options.clsinit), location.hash && 0 < m && h.options.target))
                                f = a.$(location.hash), f.length && setTimeout(function(a, b) {
                                    return function() {
                                        b.element.width();
                                        var d = a.offset(), e = d.top + a.outerHeight(), c = b.element.offset(), g = b.element.outerHeight(), f = c.top + g;
                                        c.top < e && d.top < f && (m = d.top - g - b.options.target, window.scrollTo(0, m))
                                    }
                                }(f, h), 0);
    ...
    return a.component("sticky", {
        ...
        init: function() {
            ...
            this.sticky = {
                ...
                calcTop: function() {
                    ...
                    if (this.options.top && "string" == typeof this.options.top)
                        if (this.options.top.match(/^(-|)(\d+)vh$/))
                            b = window.innerHeight * parseInt(this.options.top, 10) / 100;
                        else {
                ...
                check: function() {
                    ...
                    var d = c.scrollTop(), g = b.height() - window.innerHeight, g = d > g ? g - d: 0, g = this.wrapper.offset().top - this.top - g, d = d >= g;
        ...
        computeWrapper: function() {
            ...
            "fixed" ==
            this.element.css("position") && this.element.css({
...
!function(a) {
    ...
    return a.component("tooltip", {
        ...
        show: function() {
            if (this.tip = "function" == typeof this.options.src ? this.options.src(this.element) : this.options.src, c && clearTimeout(c), b && clearTimeout(b), "string" ==
                typeof this.tip ? this.tip.length : 0) {
                f.stop().css({
                    top: - 2E3,
                    visibility: "hidden"
        ...
        hide: function() {
            if (!this.element.is("input") ||
                ...
                if (c && clearTimeout(c), b && clearTimeout(b), f.stop(), this.options.animation) {
                    var a = this;
                    f.fadeOut(parseInt(this.options.animation, 10) || 400, function() {
                        f.removeClass(a.options.activeClass)
                    })
                } else
                    f.hide().removeClass(this.options.activeClass)
        },
        content: function() {
            return this.tip
        },
...
!function(a) {
    ...
    function f(b) {
        return c ? (c.lightbox = b, c) : (c = a.$(['<div class="uk-modal">', '<div class="uk-modal-dialog uk-modal-dialog-lightbox uk-slidenav-position" style="margin-left:auto;margin-right:auto;width:200px;height:200px;top:' + Math.abs(window.innerHeight / 2 - 200) + 'px;">', '<a href="#" class="uk-modal-close uk-close uk-close-alt"></a><div class="uk-lightbox-content"></div><div class="uk-modal-spinner uk-hidden"></div></div></div>'].join("")).appendTo("body"),
            c.dialog = c.find(".uk-modal-dialog:first"), c.content = c.find(".uk-lightbox-content:first"), c.loader = c.find(".uk-modal-spinner:first"), c.closer = c.find(".uk-close.uk-close-alt"), c.modal = a.modal(c, {
            modal: !1
        }), c.on("swipeRight swipeLeft", function(a) {
    ...
    return a.component("lightbox", {
        ...
        boot: function() {
            ...
            a.$doc.on("keyup", function(a) {
                if (c &&
                    c.is(":visible") && c.lightbox.options.keyboard)
        ...
        init: function() {
            ...
            if (this.index = 0, this.siblings = [], this.element && this.element.length) {
                ...
                c.each(function() {
                    ...
                    b.push({
                        source: d.attr("href"),
                        title: d.attr("data-title") || d.attr("title"),
                        type: d.attr("data-lightbox-type") ||
                        "auto",
                        link: d
                    })
                });
            ...
            c.on("showitem.uk.lightbox", function(c, d) {
                var f = function(a, b, c) {
                    d.meta = {
                        ...
                        a + '" width="' + b + '" height="' + c + '" controls></video>',
                        width: b,
                        height: c
                    };
                    d.type = "video";
                ...
                if ("video" == d.type || d.source.match(/\.(mp4|webm|ogv)$/i))
                    if (b[d.source])
                        f(d.source, b[d.source].width, b[d.source].height);
                    else
                        var g = a.$('<video style="position:fixed;visibility:hidden;top:-10000px;"></video>').attr("src", d.source).appendTo("body"), p = setInterval(function() {
...
function comments() {
    $("#submit").click(function() {
        ...
        if ("" == $("#comment").val())
            return $("#comment").addClass("uk-form-danger"), $("#comment").attr("placeholder",
                "\u5185\u5bb9\u4e0d\u80fd\u4e3a\u7a7a"), !1;
        if ("" == $("#author").val())
            return $("#author").addClass("uk-form-danger"), $("#author").attr("placeholder", "\u6635\u79f0\u4e0d\u80fd\u4e3a\u7a7a"), !1;
        if ("" == $("#email").val())
            return $("#email").addClass("uk-form-danger"), $("#email").attr("placeholder", "\u90ae\u7bb1\u4e0d\u80fd\u4e3a\u7a7a"), !1
    });
...
function ajaxloadPage(a, f, c) {
    ajaxisLoad || (1 == ajaxscroll_top && jQuery("html,body").animate({
        scrollTop: 0
    }, 1500), ajaxstarted = ajaxisLoad=!0, nohttp = a.replace("http://", "").replace("https://", ""), firstsla = nohttp.indexOf("/"), pathpos = a.indexOf(nohttp), path = a.substring(pathpos + firstsla), 1 != f && "function" == typeof window.history.pushState && history.pushState({
        foo: 1E3 + 1001 * Math.random()
    }, "ajax page loaded...", path), jQuery("#" + ajaxcontent), jQuery("#" + ajaxcontent).append(ajaxloading_code), jQuery("#index").children().fadeTo("slow",
        0, function() {}), jQuery("#" + ajaxcontent).fadeTo("slow", 1, function() {
        jQuery("#" + ajaxcontent).fadeIn("slow", function() {
            jQuery.ajax({
                ...
                success: function(a) {
                    ...
                    if (2 == datax.length || 2 == titlesx.length)
                        a = a.split("<title>")[1], titles = a.split("</title>")[0], jQuery(document).attr("title", jQuery("<div/>").html(titles).text());
                    ...
                    for (var f = 1, e = ""; 0 < f;) {
                        temp = a.split("</div>")[0];
                        i = 0;
                        for (pos = temp.indexOf("<div"); - 1 != pos;)
                            i++, pos = temp.indexOf("<div", pos + 1);
                        f = f + i - 1;
...
function ajaxcheck_ignore(a) {
    for (var f in ajaxignore)
        if (0 <= a.indexOf(ajaxignore[f]))
            return !1;
    return !0
}
